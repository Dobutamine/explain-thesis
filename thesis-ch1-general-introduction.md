...
**[VERIFY]** reuse the running series pool (`_references.md`) and are to be confirmed against
...
marked **[VERIFY]** are to be confirmed against PubMed before submission, per `_references.md`.*
