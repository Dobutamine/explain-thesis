...
1. ~~**Assemble the manuscript**~~ — ✅ **done 2026-07-12** → `chd-paper.md` (see banner). Remaining on it: real `[P1]`–`[P6]` companion citations, deposit URL/DOI, Word-table conversion.
